                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div class="flex flex-col justify-center">
                            ...
                            <div class="mt-8 flex flex-col sm:flex-row gap-4 flex-wrap">
                                ...
                                <button type="button" class="flex-1 bg-red-600 border border-transparent rounded-md py-3 px-8 flex items-center justify-center text-base font-medium text-white hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors shadow-sm disabled:opacity-50 disabled:cursor-not-allowed" @if($product->stock <= 0) disabled @endif>
                                ...
                                <div class="w-full mt-2 text-sm text-gray-500">
                                    Sisa Stok: <span class="font-bold {{ $product->stock > 0 ? 'text-green-600' : 'text-red-600' }}">{{ $product->stock > 0 ? $product->stock . ' Unit' : 'Habis' }}</span>
                                </div>
                            </div>
                        </div>
