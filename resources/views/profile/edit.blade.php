                                        ...
                                        <div class="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                                            ...
                                            <div class="flex items-center gap-3">
                                                ...
                                                <a href="{{ route('orders.show', $order) }}"
                                                    class="inline-flex items-center justify-center rounded-lg border border-[#500000] px-4 py-2 text-xs font-bold uppercase tracking-wide text-[#500000] transition hover:bg-[#500000] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#500000] focus:ring-offset-2">
                                                    Lihat Invoice
                                                </a>
